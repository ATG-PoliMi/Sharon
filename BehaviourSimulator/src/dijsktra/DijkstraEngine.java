...
public class DijkstraEngine {
	...
	public void buildAdjacencyMatrix(int[][] map) {
		System.out.println("L1: "+map.length);
		System.out.println("L2: "+map[0].length);
		System.out.println(map[5][5]);
		System.out.println(map[5][10]);
		System.out.println(map[5][15]);
		System.out.println(map[10][15]);
		System.out.println(map[10][20]);
		System.out.println(map[10][25]);
		int row = map.length;
