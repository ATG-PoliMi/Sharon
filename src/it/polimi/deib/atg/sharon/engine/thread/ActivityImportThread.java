            ...
            for (File CurrentFile : orderedList) {
                ...
                for (String pattern : configLines) {
                    ...
                    if (startSec != null) {
                        ...
                        //System.out.println("The activity "+oldIdAct+" start at "+startSec+" ("+stinday+") finish at"+endSec+" ("+eninday+"). Tot duration"+diff.toString());
                        ADLQueue a = new ADLQueue(Integer.parseInt(oldIdAct), diff);
                        q.add(a);
                    }
                    oldIdAct = idAct;
                ...
                long eninday = Long.parseLong(endSec) % 86400;
                //System.out.println("The activity "+oldIdAct+" start at "+startSec+" ("+stinday+") finish at"+endSec+" ("+eninday+"). Tot duration"+diff.toString());
                ADLQueue a = new ADLQueue(Integer.parseInt(oldIdAct), diff - 1);
                q.add(a);
