...
public class LLADLDB {
	...
	public static Map<Integer, LowLevelADL> addLLADL() {
		...
		p.put(3, new LowLevelADL(3, "GoingOut1", new ArrayList<Station>(Arrays.asList(new Station(8, 1.0)))));
		p.put(4, new LowLevelADL(4, "GoingOut2", new ArrayList<Station>(Arrays.asList(new Station(1, 0.05), new Station(8, 0.95)))));
		...
		p.put(11, new LowLevelADL(11, "Excretion1", new ArrayList<Station>(Arrays.asList(new Station(4, 1.0)))));
		p.put(12, new LowLevelADL(12, "Excretion2", new ArrayList<Station>(Arrays.asList(new Station(4, 0.9), new Station(5, 0.1)))));
